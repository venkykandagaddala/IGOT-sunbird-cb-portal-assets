CKEDITOR.plugins.add('simpleAudioUpload', {
    init: function (editor) {
        var audiofileDialog = $('<input type="file" id="audio" name="audio" accept="audio/mp3,audio/*;">')
        ...
        audiofileDialog.on('change', function (e) {
            ...
            if (file.size > 400 * 1048576) {
                ...
                var fileToLoad = audiofileDialog[0].files[0]
        ...
        editor.addCommand('openAudioDialog', {
