CKEDITOR.plugins.add('simpleVideoUpload', {
    init: function (editor) {
        var videofileDialog = $('<input type="file" id="video" name="video" accept="video/mp4,video/x-m4v,video/*">')
        ...
        videofileDialog.on('change', function (e) {
            ...
            if (file.size > 400 * 1048576) {
                ...
                var fileToLoad = videofileDialog[0].files[0]
                ...
                $.ajax({
                    ...
                    $.ajax({
                        ...
                        ele.setAttribute('disablePictureInPicture', 'true')
        ...
        editor.addCommand('openVideoDialog', {
